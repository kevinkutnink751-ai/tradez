        ...
        <div class="trading-header px-3 py-2 border-bottom d-flex align-items-center justify-content-between" style="background: #11151d;">
            <div class="d-flex align-items-center">
                <div class="dropdown mr-4">
                    <button class="btn btn-dark-input dropdown-toggle font-weight-bold text-white px-3" type="button" data-toggle="dropdown">
                        <i class="fas fa-chart-line mr-2 text-primary"></i> {{ $currentPair->name }}
                    </button>
            ...
            <div class="d-flex align-items-center">
                <div class="text-right mr-3">
                    ...
                    <span class="text-white font-weight-bold">{{ number_format(Auth::user()->future_bal, 2) }} USDT</span>
                </div>
        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-6 trading-panel border-right d-flex flex-column">
                <div class="chart-container flex-grow-1" style="min-height: 400px;">
                    ...
                    @php
                        $symbol = str_replace('/', '', $currentPair->name);
                        $prefix = (strpos($currentPair->name, 'USDT') !== false) ? 'BINANCE:' : 'FX:';
                        if ($prefix == 'BINANCE:') {
                            $symbol .= '.P'; // Perpetual futures for crypto
                        }
                    @endphp
                        ...
                        <div class="col-md-12">
                            <form action="{{ route('future.trade.store') }}" method="POST" class="ajax-trade-form" id="futureTradeForm">
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <span class="text-white small font-weight-bold">{{ number_format(Auth::user()->wallets()->whereHas('asset', function($q){$q->where('symbol','USD');})->first()->future_bal ?? 0, 4) }} USD</span>
                                </div>
                                ...
                                <div class="input-group input-group-sm mb-3">
                                    ...
                                    <div class="input-group-append"><span class="input-group-text bg-dark border-secondary text-muted">USD</span></div>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    <input type="range" class="custom-range" min="0" max="100" value="0" id="percentageSlider" name="leverage">
                                ...
                                <div class="trade-stats mt-4">
                                    <div class="d-flex justify-content-between small mb-2">
                                        ...
                                        <span class="text-white font-weight-bold" id="statSize">0.0000 USD</span>
                                    </div>
                                    <div class="d-flex justify-content-between small mb-2">
                                        <span class="text-muted">Cost:</span>
                                        <span class="text-white font-weight-bold" id="statCost">0.0000 USD</span>
                                    </div>
                                    <div class="d-flex justify-content-between small mb-2">
                ...
                <div class="p-3">
                    ...
                    <div class="border-top border-white-10 pt-3 mb-4">
                        ...
                        <div class="d-flex justify-content-between small mb-2">
                            ...
                            <span class="text-white">{{ number_format(Auth::user()->wallets()->whereHas('asset', function($q){$q->where('symbol','USD');})->first()->future_bal ?? 0, 2) }} USD</span>
                        </div>
                        <div class="d-flex justify-content-between small mb-2">
                    ...
                    <div class="table-responsive">
                        <table class="table table-dark-custom small">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="font-weight-bold text-white">{{ $position->pair }}</td>
                                    <td>
                                        <span class="badge badge-{{ $position->type == 'Buy' ? 'success' : 'danger' }} px-2">
                                            {{ $position->type == 'Buy' ? 'Long' : 'Short' }}
                                        </span>
                                    </td>
                                    <td class="text-white">{{ number_format($position->amount, 2) }} USD</td>
                                    <td class="text-warning">{{ $position->leverage }}x</td>
                                    <td class="text-white">{{ number_format($position->price, 2) }}</td>
                                    <td class="text-white">{{ number_format($currentPair->last_price, 2) }}</td>
                                    <td class="text-white">{{ number_format($position->amount / $position->leverage, 2) }} USD</td>
