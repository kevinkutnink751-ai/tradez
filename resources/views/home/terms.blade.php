        ...
        <div class="container position-relative" style="z-index:3;">
            <div class="row w-100">
                <div class="col-lg-8" data-aos="fade-right">
                    ...
                    <p class="text-muted lead mb-5 max-width-700">Read our detailed commitment to protecting your data and maintaining your privacy.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container position-relative" style="z-index:2;">
            <div class="row justify-content-center">
                <div class="col-lg-9" data-aos="fade-up">
                    <div class="p-5 rounded-lg shadow-sm bg-white" style="border: 1px solid rgba(0,0,0,0.05);">
                        <div class="card-body">
                            <h5 class="card-title font-weight-bold" style="color:#000;">Our Commitment to You:</h5>
                            <p class="text-muted">Thank you for showing interest in our service. In order for us to provide you with our service, we are required to collect and process certain personal data about you and your activity.</p>
                            <p class="text-muted">By entrusting us with your personal data, we would like to assure you of our commitment to keep such information private and to operate in accordance with all regulatory laws and all EU data protection laws, including General Data Protection Regulation (GDPR) 679/2016 (EU).</p>
                            <p class="text-muted">We have taken measurable steps to protect the confidentiality, security and integrity of this data. We encourage you to review the following information carefully.</p>

                            <h5 class="card-title font-weight-bold mt-5" style="color:#000;">Grounds for data collection:</h5>
                            <p class="text-muted">Processing of your personal information (meaning, any data which may potentially allow your identification with reasonable means; hereinafter “Personal Data”) is necessary for the performance of our contractual obligations towards you and providing you with our services, to protect our legitimate interests and for compliance with legal and financial regulatory obligations to which we are subject.</p>
                            <p class="text-muted">When you use our services, you consent to the collection, storage, use, disclosure and other uses of your Personal Data as described in this Privacy Policy.</p>

                            <h5 class="card-title font-weight-bold mt-5" style="color:#000;">How do we receive data about you?</h5>
                            ...
                            <h5 class="card-title font-weight-bold mt-5" style="color:#000;">What type of data we collect?</h5>
                            <p class="text-muted">In order to open an account, and in order to provide you with our services we will need you to collect the following data:</p>
                            <p style="color:#000;"><b>Personal Data <br> We collect the following Personal Data about you:</b></p>
                            <ul class="text-muted">
                            ...
                            <h5 class="card-title font-weight-bold mt-5" style="color:#000;">Tracking Technologies</h5>
                            <p class="text-muted">When you visit or access our services we use (and authorize 3rd parties to use) pixels, cookies, events and other technologies (“Tracking Technologies“). Those allow us to automatically collect data about you, your device and your online behavior, in order to enhance your navigation in our services, improve our site’s performance, perform analytics and customize your experience on it. In addition, we may merge data we have with data collected through said tracking technologies with data we may obtain from other sources and, as a result, such data may become Personal Data. <br class="mb-2/cookies.html" class="text-primary">Cookie Policy page</a>.
                            </p>
                            <h5 class="card-title font-weight-bold mt-5" style="color:#000;">How do we use the data We collect?</h5>
                            <ul class="text-muted">
                            ...
                            <h5 class="card-title font-weight-bold mt-5" style="color:#000;">With whom do we share your Personal Data</h5>
                            <ul class="text-muted">
                            ...
                            <h5 class="card-title font-weight-bold mt-5" style="color:#000;">Transfer of data outside the EEA</h5>
                            ...
                            <h5 class="card-title font-weight-bold mt-5" style="color:#000;">How we protect your data</h5>
                            ...
                            <p class="text-muted">However, please note that these rights are not absolute, and may be subject to our own legitimate interests and regulatory requirements.</p>
                            <h5 class="card-title font-weight-bold mt-5" style="color:#000;">How to Contact us?</h5>
                            <p class="text-muted">If you wish to exercise any of the aforementioned rights, or receive more information, please contact our General Data Protection Officer (“GDPO”) using the details provided below:</p>
                            <p class="text-muted">Email: {{ $settings->contact_email }}</p>
                            <p class="text-muted">Attn. GDPO Compliance Officer</p>
                            <p class="mt-4 text-muted">If you decide to terminate your account, you may do so by emailing us at {{ $settings->contact_email }}. If you terminate your account, please be aware that personal information that you have provided us may still be maintained for legal and regulatory reasons (as described above), but it will no longer be accessible via your account.</p>
                            <h5 class="card-title font-weight-bold mt-5" style="color:#000;">Updates to this Policy</h5>
                            <p class="text-muted">This Privacy Policy is subject to changes from time to time, at our sole discretion. The most current version will always be posted on our website (as reflected in the “Last Updated” heading). You are advised to check for updates regularly. In the event of material changes, we will provide you with a notice. By continuing to access or use our services after any revisions become effective, you agree to be bound by the updated Privacy Policy.</p>
                        </div>
                    </div>
                </div>
            </div>
