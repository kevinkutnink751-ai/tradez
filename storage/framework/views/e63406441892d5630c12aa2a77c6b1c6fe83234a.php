                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-4">
                                <h5><a href="javascript:void(0)"
                                        class="text-dark"><?php echo e($content->getContent('9HOR1z', 'title')); ?></a></h5>
                ...
                <div class="pt-2 mt-4 col-md-6 col-12">
                    <div class="text-center border-0 rounded card">
                        <div class="card-body">
                            ...
                            <div class="mt-4">
                                <h5><a href="javascript:void(0)"
                                        class="text-dark"><?php echo e($content->getContent('7DH2G9', 'title')); ?></a></h5>
            ...
            <div class="row justify-content-center">
                <div class="text-center col-lg-7 col-md-7">
                    <div class="pb-2 mb-4 section-title">
                        ...
                        <p class="mx-auto mb-0 text-muted para-desc"><?php echo e($content->getContent('5Vg32I', 'description')); ?>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="pt-4 pb-4 media features">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="mb-0 text-muted para"><?php echo e($content->getContent('yGg8xI', 'description')); ?>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="pt-4 pb-4 media features">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="mb-0 text-muted para"><?php echo e($content->getContent('xEWMho', 'description')); ?>
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="pb-2 mb-4 text-center section-title">
                        <h4 class="mb-4 title"><span
                                class="text-primary"><?php echo e($content->getContent('vr6Xw0', 'title')); ?></span></h4>
                        <p class="mx-auto mb-0 para-desc text-muted"><?php echo e($content->getContent('vr6Xw0', 'description')); ?>
            ...
            <div class="row justify-content-center">
                <div class="text-center col-12">
                    <div class="pb-2 mb-4 section-title">
                        ...
                        <p class="mx-auto mb-0 text-muted para-desc"><?php echo e($content->getContent('SMsJr1', 'description')); ?>
                ...
                <div class="row align-items-end">
                    <div class="col-md-8">
                        <div class="text-center section-title text-md-left">
                            <h4 class="mb-3 text-white title title-dark"><?php echo e($content->getContent('Mnag31', 'title')); ?>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mazibuckler/apps/sites/tradez/resources/views/home/index.blade.php ENDPATH**/ ?>