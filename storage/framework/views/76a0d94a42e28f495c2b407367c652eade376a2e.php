<script>
    ...
    function getQuantity(){
        let uurl = "<?php echo e(url('/dashboard/asset-price/')); ?>" + '/' + sourceasset.value  + '/' + destinationasset.value+ '/' + amount.value;
        $.ajax({
            url: uurl,
            type: 'GET',
    ...
    function exchangeNow(event) {
        ...
        if (amount.value == '') {
            ...
            $.ajax({
                url: "<?php echo e(route('exchangenow')); ?>",
                type: 'POST',
    ...
    function getcurrbalance() {
        ...
        usdelement.forEach(element => {
            let coin = element.id;
            $.ajax({
                url: "<?php echo e(url('dashboard/balances/')); ?>" + '/' + coin,
                type: 'GET',
                success: function(response) {
                    element.textContent  = "<?php echo e($settings->currency); ?>" + response.data;
                },
                error: function(error) {
                    console.log(error);
                },
...
</script><?php /**PATH /Users/mazibuckler/apps/sites/tradez/resources/views/user/exchangescript.blade.php ENDPATH**/ ?>