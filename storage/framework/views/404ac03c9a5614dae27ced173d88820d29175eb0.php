    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body ">
                <form role="form" method="post" action="<?php echo e(route('create.master')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="form-row">
...
<?php /**PATH /Users/mazibuckler/apps/sites/tradez/resources/views/admin/subscription/master/create-master.blade.php ENDPATH**/ ?>