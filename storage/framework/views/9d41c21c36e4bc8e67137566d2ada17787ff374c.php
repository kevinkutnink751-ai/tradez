...
} elseif ($_instance->childHasBeenRendered('RqlCNpQ')) {
    $componentId = $_instance->getRenderedChildComponentId('RqlCNpQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('RqlCNpQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RqlCNpQ');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('RqlCNpQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /Users/mazibuckler/apps/sites/tradez/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>