...
} elseif ($_instance->childHasBeenRendered('kKSEMb6')) {
    $componentId = $_instance->getRenderedChildComponentId('kKSEMb6');
    $componentTag = $_instance->getRenderedChildComponentTagName('kKSEMb6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kKSEMb6');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('kKSEMb6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mazibuckler/apps/sites/tradez/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>