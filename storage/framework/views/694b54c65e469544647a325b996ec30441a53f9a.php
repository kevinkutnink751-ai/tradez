...
} elseif ($_instance->childHasBeenRendered('m5Xfjjf')) {
    $componentId = $_instance->getRenderedChildComponentId('m5Xfjjf');
    $componentTag = $_instance->getRenderedChildComponentTagName('m5Xfjjf');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('m5Xfjjf');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('m5Xfjjf', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mazibuckler/apps/sites/tradez/resources/views/user/payment.blade.php ENDPATH**/ ?>